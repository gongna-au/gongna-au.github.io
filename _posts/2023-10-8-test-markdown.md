...
**在很多数据库系统（如MySQL）中，可以开启慢查询日志功能，它会记录执行时间超过指定阈值的查询。**
检查慢查询日志：
```shell
...
**键盘敲击中断就是当敲击键盘时，它发送一个信号给计算机，告诉它需要注意这个新输入，并相应地处理它。**
...
准备阶段：协调者询问所有参与者：“如果我现在告诉提交，是否能够提交？”
